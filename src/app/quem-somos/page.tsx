...
import { Target, User, Heart, Video } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border-2 border-gray-300 dark:border-gray-700 hover:border-primary transition-all group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="font-heading text-2xl font-bold text-gray-900 dark:text-foreground">Um Projeto Independente</h2>
            </div>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              O Vascoverso é mantido de forma independente por um torcedor apaixonado. Da concepção do conteúdo à edição final,
              tudo é feito de forma artesanal, movido puramente pelo amor ao Vasco. Embora não sejamos jornalistas profissionais,
              somos estudiosos dedicados do clube, comprometidos em trazer informação de qualidade.
            </p>
          </div>
        </div>
