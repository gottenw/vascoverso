        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border-2 border-gray-300 dark:border-gray-700 hover:border-primary transition-all group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-heading text-xl font-bold text-gray-900 dark:text-foreground">Contato Geral</h3>
            </div>
          ...
          <div className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border-2 border-gray-300 dark:border-gray-700 hover:border-primary transition-all group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-heading text-xl font-bold text-gray-900 dark:text-foreground">Sugestões de Pauta</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
